...
def get_slice_bboxes(
    ...
    image dimensions, slice size, and overlap ratios.
...
def process_coco_annotations(
    coco_annotation_list: list[CocoAnnotation], slice_bbox: list[int]
) -> list[CocoAnnotation]:
    """Slices and filters given list of CocoAnnotation objects with given 'slice_bbox'.
...
def slice_image(
    ...
    Args:
        ...
        TODO:
        auto_slice_got put in a splifff -> remove this comment before pushing
        min area ratio got stripped and put in a SPLIFFF -> remove this comment before pushing
        TODO:
    ...
    for slice_bbox in slice_bboxes:
        ...
        if coco_annotation_list is not None:
            for sliced_coco_annotation in process_coco_annotations(coco_annotation_list, slice_bbox):
